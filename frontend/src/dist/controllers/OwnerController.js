...
export default class OwnerController {
    ...
    initCenterFormEvents(center) {
        // 1. Thumbnail Upload Handling
        const thumbnailFileInput = document.getElementById("center-thumbnail-file");
        const thumbnailHiddenInput = document.getElementById("center-thumbnail");
        const thumbnailPreview = document.getElementById("center-thumbnail-preview");
        ...
        const galleryFileInput = document.getElementById("center-gallery-files");
        const galleryHiddenInput = document.getElementById("center-gallery");
        ...
        if (form) {
            form.addEventListener("submit", async (e) => {
                ...
                try {
                    ...
                    const sport_id = document.getElementById("center-sport").value;
                    const description = document.getElementById("center-description").value;
    ...
    renderGalleryPreviews(galleryUrls, container, hiddenInput) {
    ...
    initCourtFormEvents(court, centers) {
        const thumbnailFileInput = document.getElementById("court-thumbnail-file");
        const thumbnailHiddenInput = document.getElementById("court-thumbnail");
        const thumbnailPreview = document.getElementById("court-thumbnail-preview");
        if (thumbnailFileInput && thumbnailHiddenInput && thumbnailPreview) {
            thumbnailFileInput.addEventListener("change", async () => {
                const file = thumbnailFileInput.files?.[0];
                if (!file)
        ...
        if (form) {
            form.addEventListener("submit", async (e) => {
                e.preventDefault();
                try {
                    const sport_center_id = document.getElementById("court-center").value;
